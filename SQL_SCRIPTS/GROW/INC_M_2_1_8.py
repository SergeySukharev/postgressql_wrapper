# --------------------------------------------------------------------------
# ---- 2.1.8 Нарастающий итог по месяцам с начала года. Среднесуточный. ----
# --------------------------------------------------------------------------
...
# Берем сумму итогов каждого месяца, умноженную на количество дней каждого месяца и делим на количество дней всех этих месяцев
...
query_2_1_8_1 = ("""select 'tgt', count(0)
...
query_2_1_8_2 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
...
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ind.value::numeric(20,8) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
from ( 	select * from dm_rep.dm_all_indicators_v 
		where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 1
	 ) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_3 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_4 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, (ind.value*dte.month_length + ind2.value
		*dte2.month_length)/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
from ( 	select * from dm_rep.dm_all_indicators_v 
		where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 2
	) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_5 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_6 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length)
		/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length))::numeric(20,10) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
from ( 	select * from dm_rep.dm_all_indicators_v 
		where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 3
	) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
select 	clc.hcode_id, clc.hcode_name, clc.hcode_unit_name, clc.org_id, clc.dor_kod, clc.date_type_id, clc.metric_type_id, clc.cargo_type_id, 
		clc.val_type_id, clc.unit_id, clc.dt, clc.value::numeric(20,10), clc.ss, clc.duch_id, clc.nod_id, clc.dir_id, clc.kato_id, clc.vids_id, clc.depo_id, clc.dep_id
from dm_rep.dm_all_indicators_v clc
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on hcd.id = clc.hcode_id
where 	calc_rule = 'grow'
...
# Сверка кол-ва записей
query_2_1_8_7 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_8 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length)
		/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length))::numeric(20,8) as value, 
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 4
			) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_9 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_10 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length 
		+ ind5.value*dte5.month_length)/
		((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		...
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 5
			) as ind 
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on 	ind.hcode_id = hcd.id
		and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_11 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_12 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length 
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length)
		/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		+ (case when ind5.value is null then 0 else 1 end)*dte5.month_length
		+ (case when ind6.value is null then 0 else 1 end)*dte6.month_length))::numeric(24,8) as value,
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 6
			) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
select 	clc.hcode_id, clc.hcode_name, clc.hcode_unit_name, clc.org_id, clc.dor_kod, clc.date_type_id, clc.metric_type_id, clc.cargo_type_id, 
	clc.val_type_id, clc.unit_id, clc.dt, clc.value::numeric(24,8), clc.ss, clc.duch_id, clc.nod_id, clc.dir_id, clc.kato_id, clc.vids_id, clc.depo_id, clc.dep_id
from dm_rep.dm_all_indicators_v clc
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on hcd.id = clc.hcode_id
where 	calc_rule = 'grow'
...
# Сверка кол-ва записей
query_2_1_8_13 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_14 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length 
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length + ind7.value*dte7.month_length)
		/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		...
		+ (case when ind7.value is null then 0 else 1 end)*dte7.month_length))::numeric(20,6) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from ( 	select * from dm_rep.dm_all_indicators_v 
			where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 7
		) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_15 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_16 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
...
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		...
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
from ( 	select * from dm_rep.dm_all_indicators_v 
		where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 8
	) as ind 
join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
	on 	ind.hcode_id = hcd.id
	and hcd.group_type = 'среднесуточный'	
...
# Сверка кол-ва записей
query_2_1_8_17 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_18 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length 
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length + ind7.value*dte7.month_length 
		+ ind8.value*dte8.month_length + ind9.value*dte9.month_length)/
		((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		...
		+ (case when ind9.value is null then 0 else 1 end)*dte9.month_length))::numeric(20,8) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 9
			) as ind 
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on 	ind.hcode_id = hcd.id
		and hcd.group_type = 'среднесуточный'	
...
# Сверка кол-ва записей
query_2_1_8_19 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_20 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		+ ind2.value*dte2.month_length + ind3.value*dte3.month_length + ind4.value*dte4.month_length 
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length + ind7.value*dte7.month_length 
		+ ind8.value*dte8.month_length + ind9.value*dte9.month_length + ind10.value*dte10.month_length)
		/((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		...
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 10
			) as ind 
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on 	ind.hcode_id = hcd.id
		and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_21 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_22 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value, a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		...
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length + ind7.value*dte7.month_length 
		+ ind8.value*dte8.month_length + ind9.value*dte9.month_length + ind10.value*dte10.month_length 
		+ ind11.value*dte11.month_length)/
		((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		...
		ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 11
			) as ind 
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on 	ind.hcode_id = hcd.id
		and hcd.group_type = 'среднесуточный'
...
# Сверка кол-ва записей
query_2_1_8_23 = ("""select 'tgt', count(0)
	from dm_rep.dm_all_indicators_v clc
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on clc.hcode_id = hcd.id
where 	calc_rule = 'grow'
...
# Сравнение всех записей в таблицах
query_2_1_8_24 = ("""select 	a.hcode_id, a.hcode_name, a.hcode_unit_name, a.org_id, a.dor_kod, a.date_type_id, a.metric_type_id, a.cargo_type_id, 
		a.val_type_id, a.unit_id, a.dt, a.value::numeric(20,8), a.ss, a.duch_id, a.nod_id, a.dir_id, a.vids_id, a.kato_id, a.depo_id, a.dep_id
from (
select 	ind.hcode_id, ind.hcode_name, ind.hcode_unit_name, ind.org_id, ind.dor_kod, 4 as date_type_id, ind.metric_type_id, 
		ind.cargo_type_id, 5 as val_type_id, ind.unit_id, ind.dt, ((ind.value*dte.month_length 
		...
		+ ind5.value*dte5.month_length + ind6.value*dte6.month_length + ind7.value*dte7.month_length 
		+ ind8.value*dte8.month_length + ind9.value*dte9.month_length + ind10.value*dte10.month_length 
		+ ind11.value*dte11.month_length + ind12.value*dte12.month_length)/
		((case when ind.value is null then 0 else 1 end)*dte.month_length 
		+ (case when ind2.value is null then 0 else 1 end)*dte2.month_length
		+ (case when ind3.value is null then 0 else 1 end)*dte3.month_length
		+ (case when ind4.value is null then 0 else 1 end)*dte4.month_length
		...
		+ (case when ind12.value is null then 0 else 1 end)*dte12.month_length))::numeric(20,8) as value, ind.ss, ind.duch_id, ind.nod_id, ind.dir_id, ind.vids_id, ind.kato_id, ind.depo_id, ind.dep_id
	from 	( 	select * from dm_rep.dm_all_indicators_v 
				where vt = 'BASE' and val_type_id = 7 and date_type_id = 4 and metric_type_id = 17 and date_part('month', dt) = 12
			) as ind 
	join (select distinct id, group_type from dm_stg.d_hcode_t) hcd
		on 	ind.hcode_id = hcd.id
		and hcd.group_type = 'среднесуточный'
...
QUERYS_2_1_8 = [v for v in locals() if v.startswith('query')]

QUERYS_2_1_8_EQUAL = [n for n in QUERYS_2_1_8 if QUERYS_2_1_8.index(n) % 2 == 0]
QUERYS_2_1_8_EMPTY = [n for n in QUERYS_2_1_8 if QUERYS_2_1_8.index(n) % 2 != 0]